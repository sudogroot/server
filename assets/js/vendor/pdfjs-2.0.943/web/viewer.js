...
var pdfName = "/uploads/" + window.location.pathname.split("/viewer/")[1]
...
var defaultOptions = {
  ...
  cMapUrl: {
    value: '/assets/js/vendor/pdfjs-2.0.943/web/cmaps/',
    kind: OptionKind.API
  },
  disableAutoFetch: {
    value: false,
  ...
  workerSrc: {
    value: '/assets/js/vendor/pdfjs-2.0.943/build/pdf.worker.js',
    kind: OptionKind.WORKER
  }
};
{
